...
import static org.openmhealth.schema.domain.TemporalRelationshipToPhysicalActivity.AT_REST;
...
public class HeartRateUnitTests extends SerializationUnitTests {
    ...
    public void builderShouldThrowExceptionOnUndefinedHeartRateValue() {
