...
public class BodyMassIndex2 extends Measure {

    public static final SchemaId SCHEMA_ID = new SchemaId(OMH_NAMESPACE, "body-mass-index", "2.0");

    private TypedUnitValue<BodyMassIndexUnit2> bodyMassIndex;


    @SerializationConstructor
    protected BodyMassIndex2() {
    }

    public static class Builder extends Measure.EffectiveTimeFrameBuilder<BodyMassIndex2, Builder> {
        ...
        @Override
        public BodyMassIndex2 build() {
            return new BodyMassIndex2(this);
        }
    }

    private BodyMassIndex2(Builder builder) {
        super(builder);

        bodyMassIndex = builder.bodyMassIndex;
    }

    public TypedUnitValue<BodyMassIndexUnit2> getBodyMassIndex() {
    ...
    public boolean equals(Object o) {
        ...
        BodyMassIndex2 that = (BodyMassIndex2) o;
